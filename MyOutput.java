...
public class MyOutput {
    public static void main(String args[]) throws CloneNotSupportedException {
        ...
        System.out.println(dataLine1.getMovement().getFormatted()); // Direction abbreviation should be expanded to the
                                                                    // full spelling
        ...
        // Hint: You cannot use the built-in ArrayList clone- think about how to break
        // the link and clone the elements
        ...
        // Example of testing invalid input- modify the data as needed to try various
        // invalid scenarios
        // If you want to check IllegalArgumentExceptions being thrown, you can
        // instantiate RobotDataLine, Movement, and Sensor. Bad data lines should be
        // skipped by RobotDataRecord.
    ...
    public static String[] getBadData() {
        ...
        String[] dataLog = {
                ...
                "Robot 890AZ - - [02/03/2022] \"BACKWARDS - NS (infrared)\"" }; // Contains invalid id and invalid
                                                                                // movement
        return dataLog;
    }
